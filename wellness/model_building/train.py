...
mlflow.set_experiment("wellness_experiment")
...
with mlflow.start_run():
    ...
    model_path = "tourism_best_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="tourism_best_model_v1.joblib",
        path_in_repo="tourism_best_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type
    )
